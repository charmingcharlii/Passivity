const Home = () => {
    return (
        <div class="flex items-center justify-center h-screen">
            <div class="transform md:rounded-md py-20 bg-stone-100 my-20">
                <div class="grid grid-cols-1 sm:grid-cols-2  gap-10 mx-auto  items-center max-w-6xl mx-auto">
                    ...
                    <div>
                        <div class="transform md:rounded-md absolute bg-slate-300 transform -translate-x-10 relative h-64">
                        </div>
