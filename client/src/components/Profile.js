            ...
            <div className="px-4 py-6 sm:px-0">
              <div className="h-96 rounded-lg border-4 border-dashed border-gray-200">
                ...
                <form className="mt-4">
                    ...
                    <input onChange={(e)=> {setUsername(e.target.value)}} value={username} type="text" className="placeholder:italic placeholder:text-slate-400 block mx-auto my-2 bg-white w-5/6 sm:w-3/6 border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"></input>
                    ...
                    <button onClick={(e)=>handleSubmit(e)} className="bg-purple-500 btn section-btn">Submit</button>
                </form> :
                <div>
                    <p className="my-4 text-2xl hover:cursor-pointer underline" onClick={()=>{setChangeForm(true)}}>Username: {username}</p>
